...
public final class BlockFamiliesFactory
  ...
  public BlockFamilies create(RegistrationContext registrationContext) {
    ...
    registerKelpWoodType(blockFamilies, registrationContext, "blue",
                         MapColor.COLOR_BLUE);

    registerKelpWoodType(blockFamilies, registrationContext, "red",
                         MapColor.COLOR_RED);

    registerKelpWoodType(blockFamilies, registrationContext, "orange",
                         MapColor.COLOR_ORANGE);

    registerKelpWoodType(blockFamilies, registrationContext, "pink",
                         MapColor.COLOR_PINK);

    registerKelpWoodType(blockFamilies, registrationContext, "yellow",
  ...
  private static void
  registerKelpWoodType(BlockFamilies blockFamilies,
                       RegistrationContext registrationContext, String color,
                       MapColor MC) {
    blockFamilies.register(
        blockFamilies
            .getOrganicBuilder(BlockFamilies.getOverworldWoodType(
                                   registrationContext, color + "_kelp"),
                               MC, color + "_kelp",
                               BuiltinDimensionTypes.OVERWORLD, true)
